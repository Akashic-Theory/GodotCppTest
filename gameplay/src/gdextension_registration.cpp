...
extern "C" {
    GDExtensionBool GDE_EXPORT gameplay_library_init(const GDExtensionInterface* interface, const GDExtensionClassLibraryPtr library, GDExtensionInitialization* initialization) {
